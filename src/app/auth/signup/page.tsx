            ...
            <div className="max-w-5xl w-full bg-white dark:bg-slate-900 rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row min-h-[700px]">
                ...
                <div className="hidden md:flex md:w-1/2 bg-blue-600/5 dark:bg-blue-600/10 flex-col justify-between p-12 relative overflow-hidden">
                        ...
                        <div className="w-full aspect-square max-w-[320px] bg-gradient-to-br from-blue-600/20 to-blue-600/5 rounded-2xl shadow-inner flex items-center justify-center p-8">
                            <div className="relative w-full h-full bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6 flex flex-col gap-4">
                                ...
                                <div className="absolute -right-4 top-1/4 bg-blue-600 text-white px-3 py-1 rounded-full text-xs shadow-lg flex items-center gap-1 font-medium">
                                    <Lightbulb className="w-4 h-4" /> Expand your mind
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="mt-4 text-slate-500 dark:text-slate-400 font-medium tracking-wide text-sm uppercase">— Margaret Fuller</p>
                    </div>
                </div>
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                    <div className="max-w-md w-full mx-auto">
                        ...
                        <div className="mb-8">
                            ...
                            <p className="mt-3 text-slate-500 dark:text-slate-400">Start your journey to reading faster and better.</p>
                        </div>
                        ...
                        <div className="relative mb-6">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-white dark:bg-slate-900 px-4 text-slate-400 font-semibold tracking-widest">Or sign up with email</span>
                            </div>
                        </div>
                        ...
                        <form className="space-y-4" action={signup}>
                            <div>
                                ...
                                <input name="email" type="email" id="email" className="w-full px-4 py-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-all outline-none" placeholder="name@company.com" required />
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input name="password" type="password" id="password" className="w-full px-4 py-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-all outline-none" placeholder="••••••••" required />
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input name="confirmPassword" type="password" id="confirmPassword" className="w-full px-4 py-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-all outline-none" placeholder="••••••••" required />
                                    <button type="button" className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200">
                                        <Eye className="w-5 h-5" />
                                    </button>
                                </div>
                            ...
                            <button type="submit" className="w-full mt-2 bg-blue-600 text-white font-bold py-3.5 px-4 rounded-lg hover:bg-blue-700 shadow-lg shadow-blue-600/20 active:scale-[0.98] transition-all">
                                Create Account
                            </button>
                        </form>
                        ...
                        <p className="mt-6 text-center text-sm text-slate-600 dark:text-slate-400">
                            ...
                            <Link href="/auth/login" className="font-bold text-blue-600 hover:underline ml-1">Log in</Link>
                        </p>

                        <div className="mt-8 flex justify-center gap-6 text-xs font-medium text-slate-400 dark:text-slate-500 uppercase tracking-widest">
                            <Link href="#" className="hover:text-slate-600 dark:hover:text-slate-300">Terms</Link>
                            <span>•</span>
                            <Link href="#" className="hover:text-slate-600 dark:hover:text-slate-300">Privacy</Link>
                        </div>
                    </div>
                </div>
            </div>
